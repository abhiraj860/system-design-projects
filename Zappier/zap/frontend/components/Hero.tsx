        ...
        <div className="flex justify-center pt-4">
            <div className="flex">
                ...
                <PrimaryButton onClick={() => {
                    router.push("/signup")
                }} size="big"><span className="text-base">Get Started free</span>
                </PrimaryButton>
                </div>
                <div className="pl-4">
                    <SecondaryButton  onClick={() => {}} size="big"> <span className="text-base font-bold">Contact Sales</span></SecondaryButton>
                </div>
            </div>
        </div>
